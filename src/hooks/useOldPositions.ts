...
// NonfungiblePositionManager.positions(uint256 tokenId) returns (nonce,operator,token0,token1,tickSpacing,tickLower,tickUpper,liquidity,feeGrowthInside0LastX128,feeGrowthInside1LastX128,tokensOwed0,tokensOwed1)
