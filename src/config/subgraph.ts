...
// The Graph gateway endpoint for WindSwap protocol data (Sei)
export const SUBGRAPH_URL = process.env.NEXT_PUBLIC_SUBGRAPH_URL ||
  'https://gateway.thegraph.com/api/subgraphs/id/GWUAkdQ6ZfVkT8iMNzzKrGF2CCFjk6nya5mdjNSPdM4k';
